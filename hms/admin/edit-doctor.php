...
else
{
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql=mysqli_query($conn,"update doctors set specialization='$docspecialization',doctorName='$docname',address='$docaddress',docFees='$docfees',contactno='$doccontactno',docEmail='$docemail' where id='$did'");
        if($sql)
        {
...
<head>
    ...
    <title>Admin | Manage-Doctors | Edit Doctor</title>
                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <div class="panel panel-white">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                ?>
                                                <h4>
                                                    <?php echo htmlentities($data['doctorName']);?>'s Profile
                                                </h4>
